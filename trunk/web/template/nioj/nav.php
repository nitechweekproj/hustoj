      ...
      <div class="sui-navbar navbar-inverse">
        <div class="navbar-inner">
          ...
          <?php if(isset($_GET['cid'])){
            $cid=intval($_GET['cid']);
          ?>
                <li <?php if (strpos($url,"contest.php")) echo " $ACTIVE";?>><a href="<?php echo $path_fix?>contest.php?cid=<?php echo $cid?>">
                  <?php echo $MSG_PROBLEMS?>
                </a></li>
                <li <?php if (strpos($url,"status.php")) echo " $ACTIVE";?>><a href="<?php echo $path_fix?>status.php?cid=<?php echo $cid?>">
